...
{
?>
        <div id="adminbutton"><a href="admin.php?gouser=<?php echo $PHP_AUTH_USER; ?>&gopass=<?php echo $PHP_AUTH_PW; ?>" title="Vicidial Admin" id="admin">Amministrazione</a></div>
        <div id="goadminbutton"><a href="../admin.php?gouser=<?php echo $PHP_AUTH_USER; ?>&gopass=<?php echo $PHP_AUTH_PW; ?>" title="GO Admin" id="goadmin">Home</a></div>
<?php
}
else
{
?>
        <div id="adminbuttons"><a href="admin.php?gouser=<?php echo $PHP_AUTH_USER; ?>&gopass=<?php echo $PHP_AUTH_PW; ?>" title="Vicidial Admin" id="admin">Amministrazione</a></div>
<?php
}
?>
...
<div id="contents" align="center">    
	...
	<?php if ($reports_only_user < 1) {
		?>
	<TD> &nbsp; <A HREF="admin.php" ALT="Users"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B>Utenti</B></A> &nbsp; </TD>
	<TD> &nbsp; <A HREF="admin.php?ADD=10" ALT="Campaigns"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B>Campagne</B></A> &nbsp; </TD>
	<TD> &nbsp; <A HREF="admin.php?ADD=100" ALT="Lists"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B>Liste</B></A> &nbsp; </TD>
	<TD> &nbsp; <A HREF="admin.php?ADD=1000000" ALT="Scripts"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B>Scripts</B></A> &nbsp; </TD>
	<TD> &nbsp; <A HREF="admin.php?ADD=10000000" ALT="Filters"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B>Filtri</B></A> &nbsp; </TD>
	<TD> &nbsp; <A HREF="admin.php?ADD=1000" ALT="Inbound"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B>Inbound</B></A> &nbsp; </TD>
	<TD> &nbsp; <A HREF="admin.php?ADD=100000" ALT="User Groups"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B>Gruppi utenti</B></A> &nbsp; </TD>
...
{
?>
        <div id="adminbuttons"><a href="goautodial-admin/admin.php?gouser=<?php echo $PHP_AUTH_USER; ?>&gopass=<?php echo $PHP_AUTH_PW; ?>" title="Vicidial Admin" id="admin"></a></div>
<?php
}
?>
        <div id="phpmyadminbutton"><a href="../phpmyadmin/" target="_blank" title="phpMyAdmin" id="phpmyadmin">phpMyAdmin</a></div>
...
<!--<B><FONT FACE="ARIAL,HELVETICA" COLOR=white>ADMINISTRATION</FONT></B>--><BR style="font-size: 6px">
	...
	<TR BGCOLOR=<?php echo $users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="<?php echo $ADMIN ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>>Mostra Utenti </a>
	</TR><TR BGCOLOR=<?php echo $users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="<?php echo $ADMIN ?>?ADD=1"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>>Aggiungi Nuovo Utente </a>
	</TR><TR BGCOLOR=<?php echo $users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="<?php echo $ADMIN ?>?ADD=1A"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>>Copia Utente </a>
	</TR><TR BGCOLOR=<?php echo $users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="<?php echo $ADMIN ?>?ADD=550"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>>Cerca per un utente </a>
	</TR><TR BGCOLOR=<?php echo $users_color ?>><TD ALIGN=LEFT>
	 ...
	 &nbsp; <a href="./user_status.php?user=<?php echo $user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>>Stato Utente </a>
	</TR><TR BGCOLOR=<?php echo $users_color ?>><TD ALIGN=LEFT>
	...
	if ( ($SSuser_territories_active > 0) or ($user_territories_active > 0) )
	 ...
	 &nbsp; <a href="./user_territories.php?agent=<?php echo $user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>>Teritorio Utente </a> </TD></TR>
	...
	<a href="<?php echo $ADMIN ?>?ADD=10"><FONT FACE="ARIAL,HELVETICA" COLOR=<?php echo $campaigns_fc ?> SIZE=<?php echo $header_font_size ?>><?php echo $campaigns_bold ?>Campagne</a>
	</TD></TR>
	<?php
	if (strlen($campaigns_hh) > 1) 
		...
		<TD ALIGN=LEFT <?php echo $list_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=10"><FONT FACE="ARIAL,HELVETICA" COLOR=<?php echo $list_fc ?> SIZE=<?php echo $subcamp_font_size ?>>Campagne principali</a></TD>
		...
		if ($SSoutbound_autodial_active > 0)
			...
			<TD ALIGN=LEFT <?php echo $recycle_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=35"><FONT FACE="ARIAL,HELVETICA" COLOR=<?php echo $recycle_fc ?> SIZE=<?php echo $subcamp_font_size ?>>Riciclo campi</a></TD>
			</TR><TR BGCOLOR=<?php echo $campaigns_color ?>>
			...
			<TD ALIGN=LEFT <?php echo $listmix_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=39"><FONT FACE="ARIAL,HELVETICA" COLOR=<?php echo $listmix_fc ?> SIZE=<?php echo $subcamp_font_size ?>>Mix Lista</a></TD>
			<?php
			}
		?>
		</TR><TR BGCOLOR=<?php echo $campaigns_color ?>>
	...
	if ($SSoutbound_autodial_active > 0)
		...
		if (strlen($lists_hh) > 1) 
			...
			<a href="<?php echo $ADMIN ?>?ADD=100"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Mostra Nuova Lista </a>
			</TR><TR BGCOLOR=<?php echo $lists_color ?>><TD ALIGN=LEFT> &nbsp; 
			<a href="<?php echo $ADMIN ?>?ADD=111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Aggiungi Nuova Lista </a>
			</TR><TR BGCOLOR=<?php echo $lists_color ?>><TD ALIGN=LEFT> &nbsp; 
			<a href="admin_search_lead.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Ricerca per Campo </a>
			</TR><TR BGCOLOR=<?php echo $lists_color ?>><TD ALIGN=LEFT> &nbsp; 
			<a href="<?php echo $ADMIN ?>?ADD=121"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> <?php echo $DNClink ?> </a>
			</TR><TR BGCOLOR=<?php echo $lists_color ?>><TD ALIGN=LEFT> &nbsp; 
			<a href="./admin_listloader_third_gen.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Carica Nuovi campi </a>
			<?php
			if ($SScustom_fields_enabled > 0)
				{
				?>
				</TR><TR BGCOLOR=<?php echo $lists_color ?>><TD ALIGN=LEFT> &nbsp; 
				<a href="./admin_lists_custom.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Campi lista personalizzati </a>
				</TR><TR BGCOLOR=<?php echo $lists_color ?>><TD ALIGN=LEFT> &nbsp; 
				<a href="./admin_lists_custom.php?action=COPY_FIELDS_FORM"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Copia campi personali </a>
				<?php
				}
			?>
			</TD></TR>
	...
	if (strlen($scripts_hh) > 1) 
		...
		<a href="<?php echo $ADMIN ?>?ADD=1000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> mostra Scripts </a>
	...
	if ($SSoutbound_autodial_active > 0)
		...
		<a href="<?php echo $ADMIN ?>?ADD=10000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Mostra Filters </a>
	...
	<a href="<?php echo $ADMIN ?>?ADD=100000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?php echo $usergroups_fc ?> SIZE=<?php echo $header_font_size ?>><?php echo $usergroups_bold ?> Gruppo utenti </a>
	</TD></TR>
	<?php
	if (strlen($usergroups_hh) > 1)
		...
		<a href="<?php echo $ADMIN ?>?ADD=100000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Mostra Groppo utenti </a>
		</TR><TR BGCOLOR=<?php echo $usergroups_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<?php echo $ADMIN ?>?ADD=111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Agg nuovo Gruppo Utente </a>
		</TR><TR BGCOLOR=<?php echo $usergroups_color ?>><TD ALIGN=LEFT> &nbsp; 
	...
	<a href="<?php echo $ADMIN ?>?ADD=10000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?php echo $remoteagent_fc ?> SIZE=<?php echo $header_font_size ?>><?php echo $remoteagent_bold ?> Agenti Remoti </a>
	</TD></TR>
	<?php
	if (strlen($remoteagent_hh) > 1) 
		...
		<a href="<?php echo $ADMIN ?>?ADD=10000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Mostra Agente Remoto </a>
		</TR><TR BGCOLOR=<?php echo $remoteagent_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<?php echo $ADMIN ?>?ADD=11111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Aggiungi Agente Remoto </a>
		</TR><TR BGCOLOR=<?php echo $remoteagent_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<?php echo $ADMIN ?>?ADD=12000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Mostra Estensioni Gruppo </a>
		</TR><TR BGCOLOR=<?php echo $remoteagent_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<?php echo $ADMIN ?>?ADD=12111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Aggiungi Estensioni Gruppo </a>
		</TD></TR>
	<?php } 
	?>
	<!-- ADMIN NAVIGATION -->
