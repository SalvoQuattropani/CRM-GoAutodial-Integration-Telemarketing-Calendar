...
if ($submit_report && $list_ids) {
	...
	print "</table>";
	passthru("$WeBServeRRooT/goautodial-admin/spreadsheet_sales_viewer.pl $list_ids $sales_number $timestamp $forc $now $dcampaign");
#	print "\n\n<BR>$WeBServeRRooT/goautodial-admin/spreadsheet_sales_viewer.pl $list_ids $sales_number $timestamp $forc $now $dcampaign<BR>\n";
	flush();
