...
#	$rslt=mysql_query($stmt, $link);
   ...
   $url = "http://10.10.10.196/goautodial-admin/closer_dispo.php?lead_id=$lead_id&channel=$channel&server_ip=$server_ip&extension=$SIPexten&call_began=$STARTtime&parked_time=$parked_time&DB=$DB";
