...
#	echo "Recording command sent for channel $channel - $filename - $recording_id<BR>\n";
   ...
   $url = "http://10.10.10.196/goautodial-admin/closer_dispo.php?lead_id=$parked_by&channel=$channel&server_ip=$server_ip&extension=$extension&call_began=$STARTtime&parked_time=$parked_time&DB=$DB";
