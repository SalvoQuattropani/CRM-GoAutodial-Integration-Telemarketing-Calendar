...
echo "<TABLE CELLSPACING=3><TR><TD VALIGN=TOP> Data:<BR>";
...
echo "</TD><TD VALIGN=TOP> Campagne:<BR>";
echo "<SELECT SIZE=5 NAME=group[] multiple>\n";
if  (eregi("--ALL--",$group_string))
	{echo "<option value=\"--ALL--\" selected>-- TUTTE LE CAMPAGNE --</option>\n";}
else
	{echo "<option value=\"--ALL--\">-- TUTTE LE CAMPAGNE--</option>\n";}
$o=0;
...
echo "Includi Drop &nbsp; <BR>Rollover:<BR>";
...
if ($carrier_logging_active > 0)
	{
	echo "</TD><TD VALIGN=TOP>Stato Carrier: &nbsp; <BR>";
...
echo "</TD><TD VALIGN=TOP>Intervallo: &nbsp; <BR>";
...
echo "</SELECT><BR><BR>\n";
echo "<INPUT type=submit NAME=SUBMIT VALUE=PROSEGUI>\n";
echo "</TD><TD VALIGN=TOP> &nbsp; &nbsp; &nbsp; &nbsp; ";
...
if (strlen($group[0]) > 1)
	...
	{
	echo " <a href=\"./admin.php?ADD=10\">CAMPAGNE</a> | \n";
	echo " <a href=\"./admin.php?ADD=999999\">REPORTS</a> </FONT>\n";
	}
echo "</TD></TR></TABLE>";
echo "</FORM>\n\n";
...
if (strlen($group[0]) < 1)
	{
	echo "\n\n";
	echo "PER FAVORE SELEZIONE LA CAMPAGNA E LA DATA PRIMA DI CLICCARE PROSEGUI\n";
	}
