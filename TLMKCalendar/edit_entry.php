...
echo '
 ...
 . 'innerHeight=20,outerWidth=420\' );" /></h2>';
...
<!-- DETAILS -->
  ...
  echo ' <div class="map_canvas"></div>
    ...
    <script>
     ...
     . '"
        ...
        $("#entry_location").geocomplete(options);
  ...
  echo '   <link rel="stylesheet" type="text/css" href="styles.css" />
     ...
     . 'id="entry_location"  placeholder="Indirizzo completo" size="90" value="' . htmlspecialchars ( $location )
     . '" /></td>
