...
# 80407-2112 - Work on adding Login Telefono load balancing across servers
...
# 90529-0741 - Added nophone agent Login Telefono that will not show any empty session alerts
...
if (file_exists('options.php'))
	...
	$user_login_first		= '0';	# set to 1 to have the vicidial_user login before the Login Telefono
	...
	$MAIN_COLOR				= '#F0FFFF';	# old default is E0C2D6
	$SCRIPT_COLOR			= '#FFFFFFFF';	# old default is FFE7D0
	$FORM_COLOR				= '#FFFFFFFF';
	$SIDEBAR_COLOR			= '#FFFFFFFF';
	}
...
if ($relogin == 'YES')
	...
	echo "<BR><BR><BR><CENTER><TABLE WIDTH=460 CELLPADDING=5 CELLSPACING=0 BGCOLOR=\"$MAIN_COLOR\"><TR BGCOLOR=WHITE>";
	...
	echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1><BR>VERSION: $version &nbsp; &nbsp; &nbsp; BUILD: by Salvo Q </TD></TR>\n";
    echo "<tr><td align=\"center\" colspan=\"2\"><font size=\"2\"><br /><B><a href=\"vicidial.php\">CLICCA QUI PER LA MOD. AUTOMATICA:</a></B></font></td></tr>\n";
	echo "</TABLE>\n";
	echo "</FORM>\n\n";
	echo "</body>\n\n";
	echo "</html>\n\n";
...
if ($user_login_first == 1)
	...
	if ( (strlen($VD_login)<1) or (strlen($VD_pass)<1) or (strlen($VD_campaign)<1) )
		...
		echo "<TABLE WIDTH=460 CELLPADDING=5 CELLSPACING=0 BGCOLOR=\"$MAIN_COLOR\"><TR BGCOLOR=WHITE>";
...
if ( (strlen($phone_login)<2) or (strlen($phone_pass)<2) )
	...
	if (!$authphone)
		...
		echo "</TR>\n";
		echo "<TR><TD ALIGN=CENTER COLSPAN=2><font size=1> &nbsp; <BR><FONT SIZE=3>Mi Dispoace: login  telefono inattiva <BR> &nbsp;</TD></TR>\n";
		echo "<TR><TD ALIGN=RIGHT>Login Telefono: </TD>";
		echo "<TD ALIGN=LEFT><INPUT TYPE=TEXT NAME=phone_login SIZE=10 MAXLENGTH=20 VALUE=\"$phone_login\"></TD></TR>\n";
		echo "<TR><TD ALIGN=RIGHT>Phone Password:  </TD>";
		echo "<TD ALIGN=LEFT><INPUT TYPE=PASSWORD NAME=phone_pass SIZE=10 MAXLENGTH=20 VALUE=\"$phone_pass\"></TD></TR>\n";
	...
	### logged in and use that Login Telefono account
		if ($pa > 0)
			{
			$pb=0;
			$pb_login='';
...
// Generate the Call Disposition Chooser panel
	function DispoSelectContent_create(taskDSgrp,taskDSstage)
		...
		var dispo_HTML = "<table cellpadding=5 cellspacing=5 width=500><tr><td colspan=2><B> CALL DISPOSITION</B></td></tr><tr><td bgcolor=\"#FFFFFFFF\" height=300 width=240 valign=top><font class=\"log_text\"><span id=DispoSelectA>";
		var loop_ct = 0;
		while (loop_ct < VD_statuses_ct)
			...
			if (loop_ct == VD_statuses_ct_half) 
				{dispo_HTML = dispo_HTML + "</span></font></td><td bgcolor=\"#FFFFFFFF\" height=300 width=240 valign=top><font class=\"log_text\"><span id=DispoSelectB>";}
			loop_ct++;
			}
...
<span style="position:absolute;left:5px;top:5px;z-index:<?php $zi++; echo $zi ?>;" id="Header">
...
<span style="position:absolute;left:0px;top:20px;z-index:<?php $zi++; echo $zi ?>;" id="Tabs">
	<TABLE border=0 bgcolor="#FFFFFF" width=<?php echo $MNwidth ?> height=30>
	<TR VALIGN=TOP ALIGN=LEFT>
	<TD ALIGN=LEFT WIDTH=115><A HREF="#" onclick="MainPanelToFront('NO');"><IMG SRC="./images/vicidial_logo.gif" ALT="MAIN"  BORDER=0></A></TD>
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="DispoSelectBox">
    <TABLE border=1 bgcolor="#E0E0E0" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center VALIGN=top> ESITO CHIAMATA :<span id="DispoSelectPhonE"></span> &nbsp; &nbsp; &nbsp; <span id="DispoSelectHAspan"><a href="#" onclick="DispoHanguPAgaiN()">Hangup Again</a></span> &nbsp; &nbsp; &nbsp; <span id="DispoSelectMaxMin"><a href="#" onclick="DispoMinimize()"> minimize </a></span><BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="CallBackSelectBox">
    <TABLE border=1 bgcolor="#CCFFCC" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center VALIGN=top> Seleziona la data di richiamo :<span id="CallBackDatE"></span><BR>
