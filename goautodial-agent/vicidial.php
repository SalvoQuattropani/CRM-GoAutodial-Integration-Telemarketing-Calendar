...
$label_middle_initial =		'Prov.';
$label_last_name =			'Cognome';
$label_address1 =			'Indirizzo1';
$label_address2 =			'Indirizzo2';
$label_address3 =			'Codice fiscale';
$label_city =				'Comune';
$label_state =				'Tipo';
$label_province =			'Intestatario offerta';
$label_postal_code =		'CAP';
$label_vendor_lead_code =	' Cod. Migrazione';
$label_gender =				'Genere';
$label_phone_number =		'Telefono';
$label_phone_code =			'Codice chiamata';
$label_alt_phone =			'Recapito alternativo';
$label_security_phrase =	'C.I.';
$label_email =				'Email';
...
if ($relogin == 'YES')
	{
	echo "<title>GoAutoDial Web Client: Re-Login</title>\n";
	echo "</head>\n";
    ...
    echo "        <td colspan=3 rowspan=3 background=images/dispo_r2_c2.jpg valign=middle>\n";
...
//    echo "</tr>\n";
    ...
    echo "<tr><td align=\"center\" colspan=\"2\"><input type=\"submit\" name=\"SUBMIT\" value=\"Entra\" /> &nbsp; \n";
    echo "<span id=\"LogiNReseT\"><input type=\"button\" value=\"Aggiorna campagna\" onclick=\"login_allowable_campaigns()\"></span></td></tr>\n";
    echo "<tr><td align=\"center\" colspan=\"2\"><font size=\"1\"><br />VICIDIAL VERSION: $version &nbsp; &nbsp; &nbsp; REBUILD by SALVO Q:</font></td></tr>\n";
	echo "<tr><td align=\"center\" colspan=\"2\"><font size=\"2\"><br /><B><a href=\"vicidial_manual.php\">CLICCA QUI PER LA MOD. MANUALE:</a></B></font></td></tr>\n";
...
//        echo "<tr><td align=\"left\" colspan=\"2\"><font size=\"1\"> &nbsp; </font></td></tr>\n";
        ...
        echo "<tr><td align=\"center\" colspan=\"2\"><font size=\"1\"><br />VICIDIAL VERSION: $version &nbsp; &nbsp; &nbsp; BUILD: $build</font></td></tr>\n";
			echo "<tr><td align=\"center\" colspan=\"2\"><font size=\"2\"><br /><B><a href=\"vicidial_manual.php\">CLICCA QUI PER LA MOD. MANUALE:</a></B></font></td></tr>\n";
        echo "</table><br>\n";
        echo "</form>\n\n";
	...
	echo "    </tbody></table>\n";
		...
		if ( (strlen($phone_login)<2) or (strlen($phone_pass)<2) )
			...
			if ( (strlen($phone_login) < 1) or (strlen($phone_pass) < 1) )
				{
				echo "<title>GoAutoDial Web Client: Login</title>\n";
				echo "</head>\n";
                echo "<body onresize=\"browser_dimensions();\"  onLoad=\"browser_dimensions();\">\n";
				if ($hide_timeclock_link < 1)
                    {echo "<a href=\"./timeclock.php?referrer=agent&amp;pl=$phone_login&amp;pp=$phone_pass&amp;VD_login=$VD_login&amp;VD_pass=$VD_pass\"> Timeclock</a><br />\n";}
...
if ( (strlen($phone_login)<2) or (strlen($phone_pass)<2) )
	{
	echo "<title>GoAutoDial Web Client:  Phone Login</title>\n";
	echo "</head>\n";
    echo "<body onresize=\"browser_dimensions();\"  onload=\"browser_dimensions();\">\n";
	if ($hide_timeclock_link < 1)
        {echo "<a href=\"./timeclock.php?referrer=agent&amp;pl=$phone_login&amp;pp=$phone_pass&amp;VD_login=$VD_login&amp;VD_pass=$VD_pass\"> Timeclock</a><br />\n";}
...
//    echo "<tr><td align=\"left\" colspan=\"2\"><font size=\"1\"> &nbsp; </font></td></tr>\n";
	...
	if (strlen($VDdisplayMESSAGE)>0) {
		echo "<center><br /><b>$VDdisplayMESSAGE</b><br /></center>";
	}
...
//        echo "<tr><td align=\"left\" colspan=\"2\"><font size=\"1\"> &nbsp; </font></td></tr>\n";
	...
	if (!$authphone)
		{
		echo "<title>GoAutoDial Web Client: Phone Login Error</title>\n";
		echo "</head>\n";
        echo "<body onresize=\"browser_dimensions();\"  onload=\"browser_dimensions();\">\n";
		if ($hide_timeclock_link < 1)
            {echo "<a href=\"./timeclock.php?referrer=agent&amp;pl=$phone_login&amp;pp=$phone_pass&amp;VD_login=$VD_login&amp;VD_pass=$VD_pass\"> Timeclock</a><br />\n";}
...
//         echo "</tr>\n";
        ...
        echo "<tr><td align=\"left\" colspan=\"2\"><font size=\"1\"><br />VICIDIAL VERSION: $version &nbsp; &nbsp; &nbsp; BUILD: $build</font></td></tr>\n";
			echo "<tr><td align=\"center\" colspan=\"2\"><font size=\"2\"><br /><B><a href=\"vicidial_manual.php\">CLICCA QUI PER LA MOD. MANUALE:</a></B></font></td></tr>\n";
        echo "</table></center><br>\n";
        echo "</form>\n\n";
...
?>
    ...
    var DiaLControl_manual_HTML_OFF = "<img src=\"./images/vdc_LB_dialnextnumber_OFF.gif\" border=\"0\" alt=\"Dial Next Number\" />";
...
// Generate the Call Disposition Chooser panel
	function DispoSelectContent_create(taskDSgrp,taskDSstage)
        ...
        var dispo_HTML = " <table  cellpadding=\"5\" cellspacing=\"5\" width=\"350px\"><tr><td colspan=\"2\"><b> ESITO CHIAMATA</b></td></tr><tr><td bgcolor=\"#06066A\" height=\"300px\" width=\"340px\" valign=\"top\"><font class=\"log_text\"><span id=\"DispoSelectA\">";
		var loop_ct = 0;
		var print_ct = 0;
		while (loop_ct < VD_statuses_ct)
			...
			if (VARSELstatuses[loop_ct] == 'Y')
				...
				if (taskDSgrp == VARstatuses[loop_ct]) 
					{
					dispo_HTML = dispo_HTML + "<font size=\"3\" style=\"BACKGROUND-COLOR: #F8F883\"><b><a href=\"#\" onclick=\"DispoSelect_submit();return false;\">" + VARstatuses[loop_ct] + " - " + VARstatusnames[loop_ct] + "</a> " + CBflag + "</b></font><br /><br />";
					}
				else
					{
				...
				if (print_ct == VD_statuses_ct_half) 
					{dispo_HTML = dispo_HTML + "</span></font></td><td bgcolor=\"#06066A\" height=\"300px\" width=\"340px\" valign=\"top\"><font class=\"log_text\"><span id=\"DispoSelectB\">";}
				print_ct++;
				}
			loop_ct++;
			}
	...
	function PauseCodeSelectContent_create()
		...
		if (move_on == 1)
			...
			if (APIManualDialQueue > 0)
                ...
                PauseCode_HTML = "<table cellpadding=\"5\" cellspacing=\"5\" width=\"500px\"><tr><td colspan=\"2\"><b> PAUSE CODE</b></td></tr><tr><td bgcolor=\"#FCA420\" height=\"300px\" width=\"240px\" valign=\"top\"><font class=\"log_text\"><span id=\"PauseCodeSelectA\">";
				var loop_ct = 0;
				while (loop_ct < VD_pause_codes_ct)
					...
					if (loop_ct == VD_pause_codes_ct_half) 
                        {PauseCode_HTML = PauseCode_HTML + "</span></font></td><td bgcolor=\"#FCA420\" height=\"300px\" width=\"240px\" valign=\"top\"><font class=\"log_text\"><span id=PauseCodeSelectB>";}
					}

				if (agent_pause_codes_active=='FORCE')
					{var Go_BacK_LinK = '';}
				else
                    {var Go_BacK_LinK = "<font size=\"3\" style=\"BACKGROUND-COLOR: #FCA420\"><b><a href=\"#\" onclick=\"PauseCodeSelect_submit('');return false;\">Go Back</a>";}
...
// Open or close the callsinqueue view bottombar
	function show_calls_in_queue(CQoperation)
		...
		if (CQoperation=='SHOW')
			{
			document.getElementById("callsinqueuelink").innerHTML = "<a href=\"#\"  onclick=\"show_calls_in_queue('HIDE');\">Nascondi chiamate in coda</a>";
			view_calls_in_queue_active=1;
			showDiv('callsinqueuedisplay');
			}
		else
			{
			document.getElementById("callsinqueuelink").innerHTML = "<a href=\"#\"  onclick=\"show_calls_in_queue('SHOW');\">Mostra chiamate in coda</a>";
...
<!--
	...
	div.scroll_script {height: <?php echo $SSheight+8 ?>px; width: <?php echo $SDwidth-40 ?>px; background: #FFFFFF; overflow: auto; font-size: 12px;  font-family: sans-serif;}
	div.noscroll_script {height: <?php echo $SSheight+8 ?>px; width: <?php echo $SDwidth-40 ?>px; background: #FFFFFF; overflow: hidden; font-size: 12px;  font-family: sans-serif;}
   ...
   .preview_text {font-size: 13px;  font-family: sans-serif; background: #F46E0B; color: #FFFFFF; font-weight: bold}
   ...
   a {font-family: Arial, Helvetica, sans-serif; font-size: 12px; color:#FF9900}
-->
</style>
<?php
echo "</head>\n";
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="Header">
	...
	<TR VALIGN=TOP ALIGN=LEFT><TD COLSPAN=3 VALIGN=TOP ALIGN=LEFT background="./images/filler.gif" nowrap>
...
<!--	 &nbsp; &nbsp; <span id="agentchannelSPAN"></span></font>-->
	<img src="./images/vicidial_logo_top.gif" align="middle" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span id=status style="font-family:sans-serif; font-size:12px; color:#FFFFFF">LIVE</span>
	</TD><TD COLSPAN=3 VALIGN=TOP ALIGN=RIGHT style="background:url(images/filler.gif) repeat-x;" nowrap><font class="body_text">
	<font class="banner_text">Cust Time: <input type=text size=20 name=custdatetime id=custdatetime class="cust_form" value=""> &nbsp; Channel: <input type=text size=15 name=callchannel id=callchannel class="cust_form" value="">
    ...
    <img src="./images/banner_right.gif" align="middle" />
	</TD></TR>
	</TABLE>
</span>
...
<span style="position:absolute;left:0px;top:46px;z-index:<?php $zi++; echo $zi ?>;" id="MainPanel">
    ...
    <TR><td align="center"><IMG SRC="./images/agc_live_call_OFF.gif" NAME=livecall ALT="Live Call" WIDTH=109 HEIGHT=30 BORDER=0></td><TD colspan=2>
	<?php
	if ($webphone_location == 'bar')
		{
    ...
    <font class="body_text" style="font-size:11px"> <strong>STATUS:</strong> <span id="MainStatuSSpan"></span> &nbsp; <strong>Session ID:</strong> <span id=sessionIDspan></span> &nbsp; <span id=AgentStatusCalls></span></font></TD></TR>
    <tr><td colspan="3"><span id="busycallsdebug"></span></td></tr>
    <tr><td width="220px" align="left" valign="top">
	<font class="body_text"><center>
	<span STYLE="background-color: #FFFFFF" id="HangupControl"><IMG SRC="./images/vdc_LB_hangupcustomer_OFF.gif" border=0 alt="Hangup Customer"></span><small>&nbsp;</small><span id="DiaLControl"><a href="#" onClick="ManualDialNext('','','','','','0');"><IMG SRC="./images/vdc_LB_dialnextnumber_OFF.gif" border=0 alt="Dial Next Number"></a></span><BR><BR style="font-size:2px">
	<span STYLE="background-color: #FFFFFF" id="ParkControl"><IMG SRC="./images/vdc_LB_parkcall_OFF.gif" border=0 alt="Park Call"></span><small>&nbsp;</small><span STYLE="background-color: #FFFFFF" id="XferControl"><IMG SRC="./images/vdc_LB_transferconf_OFF.gif" border=0 alt="Transfer - Conference"></span><BR><BR>
	...
	?> -->
   REGISTRAZIONE FILE:<br />
    <font class="body_tiny"><span id="RecorDingFilename"></span></font><br />
    REGITSTRA: <font class="body_small"><span id="RecorDID"></span></font><br />
	</center>
	<center>
    ...
    <div class="text_input" id="SendDTMFdiv"><span style="background-color: <?php echo $MAIN_COLOR ?>" id="SendDTMF"><a href="#" onclick="SendConfDTMF(session_id);return false;"><img src="./images/vdc_LB_senddtmf.gif" border="0" alt="Send DTMF" align="absmiddle" /></a>  <input type="text" size="5" name="conf_dtmf" class="cust_form" value="" maxlength="50" /></div></span><br />
	</center>
	</font>
	</td>
    ...
    <table><tr>
    <td align="right"></td>
	<td align=center><A HREF="#" onClick="MainPanelToFront('NO');"><IMG SRC="./images/customer_info.gif" ALT="VICIDIAL" WIDTH=143 HEIGHT=27 BORDER=0></A>&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#" onClick="ScriptPanelToFront();"><IMG SRC="./images/script_tab.jpg" ALT="SCRIPT" WIDTH=143 HEIGHT=27 BORDER=0></A>
	<?php if ($custom_fields_enabled > 0)
	{echo "&nbsp;&nbsp;&nbsp;&nbsp;<A HREF=\"#\" onclick=\"FormPanelToFront();\"><IMG SRC=\"./images/form_tab.jpg\" ALT=\"FORM\" WIDTH=143 HEIGHT=27 BORDER=0></A>\n";}
	?>
    </td>
	</tr>Powered by Salvo Q.<BR><tr>
    <td colspan="2" align="center"> Informazioni cliente: <span id="CusTInfOSpaN"></span> &nbsp; &nbsp; &nbsp; &nbsp; 
	<?php
	...
	if ($label_comments == '---HIDE---')
		...
		if ( ($multi_line_comments) )
            {echo "<textarea name=\"comments\" id=\"comments\" rows=\"5\" cols=\"85\" class=\"cust_form_text\" value=\"\"></textarea>\n";}
		else
...
<span style="position:absolute;left:300px;top:<?php echo $MBheight+10 ?>px;z-index:<?php $zi++; echo $zi ?>;" id="ManuaLDiaLButtons"><font class="body_text">
<span id="MDstatusSpan"><a href="#" onclick="NeWManuaLDiaLCalL('NO');return false;">CHIAMATA MANUALE</a></span> &nbsp; &nbsp; &nbsp; <a href="#" onclick="NeWManuaLDiaLCalL('FAST');return false;">CHIAMATA RAPIDA</a><br />
</font></span>
...
<span id="blind_monitor_notice_span"><b><font color="red"> &nbsp; &nbsp; <span id="blind_monitor_notice_span_contents"></span></font></b></span>
	<table border="0" id="MaiNfooter" width=<?php echo $MNwidth ?> style="background-color:#f4f4f4">
	<tr>
	<td colspan="3" align="center"><INPUT TYPE=HIDDEN NAME=extension><font class="queue_text"><?	echo "<a href=\"#\" onclick=\"start_all_refresh();\">Logged in as User:</a> <strong>$VD_login</strong> on Phone: <strong>$SIP_user</strong> to campaign: <strong>$VD_campaign</strong>&nbsp; \n"; ?></font></td>
	</tr>
	<tr>
...
<span style="position:absolute;left:<?php echo $MUwidth ?>px;top:<?php echo $CBheight+94 ?>px;z-index:<?php $zi++; echo $zi ?>;" id="VolumeControlSpan"><span id="VolumeUpSpan"><img src="./images/vdc_volume_up_off.gif" border="0" /></span><br /><span id="VolumeDownSpan"><img src="./images/vdc_volume_down_off.gif" border="0" /></span>
</font></span>
...
if ($view_calls_in_queue > 0)
	...
	if ($view_calls_in_queue_launch > 0) 
		{echo "<a href=\"#\" onclick=\"show_calls_in_queue('HIDE');\">Nascondi chiamate in coda</a>\n";}
	else 
		{echo "<a href=\"#\" onclick=\"show_calls_in_queue('SHOW');\">Mostra chiamate in coda</a>\n";}
	}
?>
</span></font>

<span style="position:absolute;left:300px;top:<?php echo $CBheight+10 ?>px;z-index:<?php $zi++; echo $zi ?>;" id="CallbacksButtons"><font class="body_text">
...
<span style="position:absolute;left:200px;top:<?php echo $SFheight ?>px;z-index:<?php $zi++; echo $zi ?>;" id="ScriptPanel">
	<?php
	if ($webphone_location == 'bar')
        {echo "<img src=\"images/pixel.gif\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
    <table border="0" id=TestSpan bgcolor="<?php echo $SCRIPT_COLOR ?>" width="<?php echo $SSwidth ?>px" height="<?php echo $SSheight ?>px"><tr><td align="left" valign="top"><font class="sb_text"><div class="scroll_script" id="ScriptContents" style="padding: 3px 3px 3px 3px; border:#000000 solid 1px">AGENT SCRIPT</div></font></td></tr></table>
</span>
...
<span style="position:absolute;left:200px;top:<?php echo $SFheight ?>px;z-index:<?php $zi++; echo $zi ?>;" id="FormPanel">
	<?php
	if ($webphone_location == 'bar')
        {echo "<img src=\"images/pixel.gif\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
    <table border="0" bgcolor="<?php echo $SCRIPT_COLOR ?>" width="<?php echo $SSwidth-50 ?>px" height="<?php echo $SSheight ?>px"><tr><td align="left" valign="top"><font class="sb_text"><div class="noscroll_script" id="FormContents" style="padding: 3px 3px 3px 3px; border:#000000 solid 1px"><iframe src="./vdc_form_display.php?lead_id=&list_id=&stage=WELCOME" style="background-color:transparent;" scrolling="auto" frameborder="0" allowtransparency="true" id="vcFormIFrame" name="vcFormIFrame" width="<?php echo $SDwidth ?>px" height="<?php echo $SSheight ?>px" STYLE="z-index:18"> </iframe></div></font></td></tr></table>
</span>
...
<span style="position:absolute;left:200px;top:<?php echo $HTheight+5 ?>px;z-index:<?php $zi++; echo $zi ?>;" id="TransferMain">
    <table bgcolor="#CCCCFF" width="<?php echo $SDwidth-25 ?>px">
    <tr valign="top">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="NoneInSessionBox">
    <table border="1" bgcolor="#FFFFFF" width="<?php echo $CAwidth ?>px" height="<?php echo $WRheight ?>px"><tr><td align="center"> No one is in your session: <span id="NoneInSessionID"></span><br />
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="CustomerGoneBox">
    <table border="1" bgcolor="#FFFFFF" width="<?php echo $CAwidth ?>px" height="<?php echo $WRheight ?>px"><tr><td align="center"> Customer has hung up: <span id="CustomerGoneChanneL"></span><br />
	<a href="#" onclick="CustomerGoneOK();return false;">Go Back</a>
    <br /><br />
	<a href="#" onclick="CustomerGoneHangup();return false;">ESITO CHIAMATA</a>
    </td></tr></table>
</span>
...
<span style="position:absolute;left:<?php echo $MNwidth-710 ?>px;top:80px;z-index:<?php $zi++; echo $zi ?>;" id="DispoSelectBox">
    <table border="1" bgcolor="#E0E0E0" width="500px" height="496px" style="font-size:10px; font-family:sans-serif; border:#000000 solid 1px"><tr><td align="center" valign="top"> ESITO CHIAMATA:<span id="DispoSelectPhonE"></span> &nbsp; &nbsp; &nbsp; <span id="DispoSelectHAspan"><a href="#" onclick="DispoHanguPAgaiN()">Hangup Again</a></span> &nbsp; &nbsp; &nbsp; <span id="DispoSelectMaxMin"><!--<a href="#" onclick="DispoMinimize()"> minimize </a>--></span><br />
	<?php
	if ($webphone_location == 'bar')
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="CallBackSelectBox">
    <table border="1" bgcolor="#CCFFCC" width="<?php echo $CAwidth ?>px" height="<?php echo $WRheight ?>px"><tr><td align="center" valign="top"> Seleziona la data di richiamo :<span id="CallBackDatE"></span><br />
	<?php
	if ($webphone_location == 'bar')
        {echo "<br /><img src=\"images/pixel.gif\" width=\"1px\" height=\"".$webphone_height."px\" /><br />\n";}
	?>
