...
if ($evnt_cmd=='ast_rel')
	{
		$confirm_msg = "<FONT style='font-family: Verdana, Helvetica, sans-serif; font-size: 12px;'  COLOR=BLACK ><b>Click GO to <B><FONT style='font-family: Verdana, Helvetica, sans-serif; font-size: 12px;'  COLOR=RED >RELOAD</FONT></B> Asterisk Telephony!</b></font>";
...
if ($evnt_cmd=='ast_res')
	{
		$confirm_msg = "<FONT style='font-family: Verdana, Helvetica, sans-serif; font-size: 12px;'  COLOR=BLACK ><b>Click GO to <B><FONT style='font-family: Verdana, Helvetica, sans-serif; font-size: 12px;'  COLOR=RED >RESTART</FONT></B> Asterisk Telephony!</b></font>";	
...
if ($evnt_cmd=='ast_sta')
	{
		$confirm_msg = "<FONT style='font-family: Verdana, Helvetica, sans-serif; font-size: 12px;'  COLOR=BLACK ><b>Click GO to <B><FONT style='font-family: Verdana, Helvetica, sans-serif; font-size: 12px;'  COLOR=RED >START</FONT></B> Asterisk Telephony!</b></font>";	
...
if ($evnt_cmd=='ast_sto')
	{
		$confirm_msg = "<FONT style='font-family: Verdana, Helvetica, sans-serif; font-size: 12px;'  COLOR=BLACK ><b>Click GO to <B><FONT style='font-family: Verdana, Helvetica, sans-serif; font-size: 12px;'  COLOR=RED >STOP</FONT></B> Asterisk Telephony!</b></font>";	
...
if (($evnt_cmd!='ast_upd_ip')&&($evnt_cmd!='ast_cti')&&($evnt_cmd!='net_eth0_upd')&&($evnt_cmd!='net_eth1_upd'))
	...
	echo "</table>\n";
		...
		echo "<TABLE class=mytableclass width=550px height=88px cellspacing=0 cellpadding=0>\n";
		echo "<form id='myForm' action='' method='get'>\n";			
		echo "<tr><td align=left> &nbsp;&nbsp;&nbsp;$confirm_msg&nbsp;&nbsp;\n";		
		echo "<input id='page1' class='sicon' type='button' name='GO' value='GO' onclick=\"javascript:loadintoIframe('myframe1', '$evnt_script', '$evnt_arg')\"></td></tr>\n";
		echo "</form>\n";
		echo "</table>\n";
		}
...
<iframe id="myframe1" src="about:blank" marginwidth="0" marginheight="0" frameborder="0" vspace="0" hspace="0" style="overflow:visible; scrollableborder:0px solid gray; border:1px solid gray; width:100%; max-width:910px; height: 100%; max-height:430px;"></iframe>
<?
}
else
{
...
<hr align=left color='#efefcb' width='100%'>
<span id="span_loader">&nbsp;</span>
<iframe id="myframe1" src="about:blank" marginwidth="0" marginheight="0" frameborder="0" vspace="0" hspace="0" style="overflow:visible; scrollableborder:0px solid gray; width:800px; min-height: 100px;"></iframe>
<?
}
?>
</div>
