...
while (list ($key, $val) = each ($file_array))
{
  ...
  if(is_dir($fname)) {
   ...
   # echo "<td><a href=g_ast_dir.php?path=$fname&edit=$edit>[dir]&nbsp;$val</a></td>";
    echo "<td  align=left style='font-size: 12px;'>&nbsp;</td>";
    echo "<td  align=left style='font-size: 12px;'><FONT FACE='VERDANA' COLOR=BLACK SIZE=2><a href=g_ast_edit.php?path=$fname>Edit</a></td>";
    ...
    if (strtolower($edit) == "yes") 
     echo "<td  align=left style='font-size: 12px;'><FONT FACE='VERDANA' COLOR=BLACK SIZE=2>$val</td>"; 
    #echo "<td><a href=g_ast_edit.php?file=$fname>$val</a></td>";
    else 
    echo "<td  align=left style='font-size: 12px;'><FONT FACE='VERDANA' COLOR=BLACK SIZE=2><a href=g_ast_send.php?file=$fname>$val</a></td>";
    echo "<td  align=left style='font-size: 12px;'><FONT FACE='VERDANA' COLOR=BLACK SIZE=2>&nbsp;</td>";
    echo "<td  align=left style='font-size: 12px;'><FONT FACE='VERDANA' COLOR=BLACK SIZE=2><a href=g_ast_edit.php?file=$fname>Edit</a></td>";
    echo "<td  align=left style='font-size: 12px;'><FONT FACE='VERDANA' COLOR=BLACK SIZE=2>&nbsp;</td>";
