...
if ($result=='asterisk.ctl')
	{
	echo "<br><br><FONT FACE='VERDANA' COLOR=BLACK SIZE=2>Asterisk telephony was successfully restarted!<br />\n";
	$socket = fsockopen("127.0.0.1", $m_port, $errno, $errstr, $timeout);
	fputs($socket, "Action: Login\r\n");
	fputs($socket, "UserName: $m_user\r\n");
	fputs($socket, "Secret: $m_pass\r\n\r\n");
	fputs($socket, "Action: Command\r\n");
	fputs($socket, "Command: restart now\r\n\r\n");
	$wrets=fgets($socket,128);
	sleep(8);
	}
	else
	{
	echo "<br><br><FONT FACE='VERDANA' COLOR=BLACK SIZE=2>No Asterisk telephony was detected running in your machine!<br />\n";
